...
console.log('SHADOW-MD connected to whatsapp ✅')                                                                              let up = `SHADOW-MD connected successful 🤖✅\n\nPREFIX: ${prefix}`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://telegra.ph/file/607ffa234287bedbefd2e.jpg` }, caption: up })
